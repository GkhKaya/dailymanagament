...
import { buildPrayerNotifications, normalizeProviderTimes, normalizeDiyanetTimes, findDiyanetDistrict, getTestNotificationTime } from '../src/lib/prayer-times.ts';
...
test('schedules a test notification one minute ahead', () => { const now = new Date('2026-08-10T12:00:00.000Z'); assert.equal(getTestNotificationTime(now).toISOString(), '2026-08-10T12:01:00.000Z'); });
